...
public class Quiz : MonoBehaviour
{
    ...
    void DisplayAnswer(int index)
    {
        ...
        if(index == currentQuestion.GetCorrectAnswerIndex())                // Ελέγχουμε αν η επιλεγμένη απάντηση είναι η σωστή
        {
        ...
        else                                                                // Αν η απάντηση είναι λανθασμένη, εντοπίζουμε τη σωστή και την εμφανίζουμε
        {
            ...
            string correctAnswer = currentQuestion.GetAnswer(correctAnswerIndex); //Εμφανίζει τη σωστή απάντηση
            ...
            buttonImage = answerButtons[correctAnswerIndex].GetComponent<Image>(); // Ενημέρωση του sprite του κουμπιού που αντιστοιχεί στη σωστή απάντηση
            buttonImage.sprite = correctAnswerSprite;                       // Εμφανίζει τη σωστή απάντηση με διαφορετική εικόνα
        }
    }

...
{
    [SerializeField] float timeToCompleteQuestion = 30f;                        // Χρόνος για την απάντηση στην ερώτηση
    [SerializeField] float timeToShowcorrectAnswer = 10f;                       // Χρόνος για την εμφάνιση της σωστής απάντησης/επιβράβευσης

...
public class EndScene : MonoBehaviour
{
    ...
    private static extern void storeScoreInFirebase(int score);
    ...
    public void ShowFinalScore()
    {
        ...
        // Κλήση της JavaScript συνάρτησης για αποθήκευση της βαθμολογίας στη Firebase
        #if UNITY_WEBGL && !UNITY_EDITOR
        storeScoreInFirebase((int)scorePercentage);
        #endif
